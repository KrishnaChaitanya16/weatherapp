...
class WeatherPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: FutureBuilder(
          future: Provider.of<WeatherProvider>(context, listen: false).fetchWeatherData(cityName, countryName),
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(left:38,top: 145,child: Text("${mainInfo['humidity']}%",style: TextStyle(color: Colors.white,fontSize: 30,fontWeight: FontWeight.w800),))
                            ]
                          ),
                        ),
                      ),
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(top:145,left:27,child: Text('${(mainInfo['feels_like'] - 273.15).toStringAsFixed(1)} °C',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 29),))
                            ]
                          ),
                        ),
                      ),
                      Expanded(
                        child: Container(
                          ...
                          child: Stack(
                            children: [Positioned(left:20,child: SizedBox(height:85,child: Image.asset('assets/windspeed.png',fit: BoxFit.cover,))),
                              Positioned(
                                top:82,
                              left: 8,
                            ...
                            Positioned(top:145,left:15,child: Text('${weatherInfo['wind']['speed']} m/s',style:TextStyle(color: Colors.white,fontWeight: FontWeight.bold ,fontSize: 29),))]
                          ),
                        ),
                      ),
                    ],
