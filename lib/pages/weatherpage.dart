                                ...
                                child: Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(top: 82, left: 8,
                                        child: Text(
                                          'Wind Speed:',
                                          style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold),
                                        ),
                                      ),
                                      Positioned(top: 145, left: 15, child: Text('${weatherInfo['wind']['speed']} m/s', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold))),
                                    ],
                                  ),
                                ),
                              ),
